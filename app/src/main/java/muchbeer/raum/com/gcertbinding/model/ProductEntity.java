...
public class ProductEntity implements Parcelable {
    ...
    //Parcelable is the way of packing an object and be passed to a bundled
    ...
    public ProductEntity(String title, String description, int image, BigDecimal price, BigDecimal sale_price, int num_ratings, BigDecimal rating, int serial_number) {
        this.title = title;
